...
public class Gato_control_JoseLuisGutierrezS {
...
public static void main(String[] args) {
	      ...
	      // Initialize the game-board and current status
	   	...
	   	while(hasWon(currentPlayer, currntRow, currentCol) == false) {
	   		printBoard();
	   		playerMove(currentPlayer);
	   		updateGame(currentPlayer, currntRow, currentCol);
	   		if(currentState == NOUGHT_WON) {
		   		System.out.println("Ganaron los circulos!");
		   		
		   	}else if(isDraw() == true) {
		   		System.out.println("Es un empate, juegen denuevo");
		   		break;
		   	}else if(currentState == CROSS_WON) {
		   		System.out.println("Ganaron las cruces!");
		   	}
	   	}
