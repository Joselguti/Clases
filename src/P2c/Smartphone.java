...
public class Smartphone {
	...
	public Vitrina iniciar() {
		...
		System.out.println("Bienvenido " + this.getNombre() + ", tenemos una ruta propuesta con puntos sigala y obtendra un premio " + "\n" );
		System.out.println("Estacion 1: Acuario Salmones (posx:46-50) (posy:106-116)" + "\n" 
						 + "Estacion 2: Acuario Moluscos (posx:10-20) (posy:50-55)" + "\n" 
						 + "Estacion 3: Acuario Ballenas (posx:21-30) (posy:56-60)");
	...
	public void caminar(Vitrina vitrina) {
		...
		System.out.println("¿Desea terminar su visita y revisar su premio?");
		...
		if(respuestapregunta.equals("si") || respuestapregunta.equals("Si")) {
			...
			if(this.getPosicionX() >= 46 && this.getPosicionX() <= 50 || this.getPosicionY() >= 106 && this.getPosicionY() <= 116) {
				...
				if(movimiento == 0) {
					...
					System.out.println("Felicidades, has ganado 10 puntos!");
				}
